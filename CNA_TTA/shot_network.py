...
class Classifier(nn.Module):
    def __init__(self,args, netB, netF, netC, train_target):
        super().__init__()
        self.args=args
        self.encoder=nn.Sequential(netF,netB)
        self.fc=netC.fc
        self._output_dim=netC.fc.in_features
    ...
    #     # case 1)
    #     if not self.use_bottleneck:
    #         backbone_params.extend(self.netF.parameters())
    #     if not self.use_bottleneck:
    #         backbone_params.extend(self.netB.parameters())
    ...
    #         # bottleneck fc + (bn) + classifier fc
    #         # extra_params.extend(resnet.fc.parameters())
    #         extra_params.extend(self.netB.parameters())
    #         extra_params.extend(self.netC.fc.parameters())
